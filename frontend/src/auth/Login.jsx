  ...
  return (
    <div className="w-full flex">
      ...
      <div className="w-1/2 bg-white flex flex-col justify-center items-center p-10">
        <img src={Logo} alt="SpenTra Logo" className="w-40 mb-4" />
      ...
      {/* Right Section */}
      <section className="bg-[url('./assets/bgImage.png')] h-[100vh] w-1/2 bg-cover bg-center flex items-center flex-col pt-15 gap-8">
